...
Stormkit enables users to set [feature flags](https://martinfowler.com/articles/feature-toggles.html) on their app. Feature flags values will be available in window.sk.features.
